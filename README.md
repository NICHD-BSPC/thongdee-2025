...
## Configure RNA-seq and RIL-seq workflows
...
file provided in the RILseq Github repo](https://github.com/asafpr/RILseq). For
...
This runs the full RNA-seq workflow for total RNA samples. In addition to
extensive QC, the main output of this workflow consists of bigWig files for
visualization of expression. They are not otherwise used in downstream
analysis.

```bash
# in workflows/rnaseq-2016
conda activate ../../env
