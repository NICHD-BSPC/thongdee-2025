...
knitr::opts_chunk$set(
    ...
    cache.extra_file_dep_1 = file.info(
      paste0('Summary_RILSeq_S-chimeras_2016_unified_', subgroup, '.xlsx')
      )$mtime
    )
```
...
fn <- paste0('Summary_RILSeq_S-chimeras_2016_unified_', subgroup, '.xlsx')
...
for (sz in names(CDS_shrink)) {
  fnout <- paste0('Summary_RILSeq_S-chimeras_2016_unified_', subgroup, '_CDSshrink', sz, '.xlsx')
