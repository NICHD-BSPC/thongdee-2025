...
```{r data}
subgroup <- 'Stationary_Phase_NoCL'
...
```{r, results='asis'}
cat(paste0('\n\n**Link to output file:** [Summary_RILSeq_S-chimeras_2016_', subgroup, '.xlsx](Summary_RILSeq_S-chimeras_2016_', subgroup, '.xlsx).'))
```
...
exported_excel(sig.chimeras, unified_fns, file=paste0('Summary_RILSeq_S-chimeras_2016_', subgroup, '.xlsx'))
```
...
exported_excel_unified(sig.unified, unified_fns,
  file=paste0('Summary_RILSeq_S-chimeras_2016_unified_', subgroup, '.xlsx'))
```
